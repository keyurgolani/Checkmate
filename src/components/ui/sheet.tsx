  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background/95 backdrop-blur-xl border-primary/20 fixed z-50 flex flex-col gap-4 shadow-2xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
        ...
        {...props}
      >
        {/* Visually hidden title for accessibility - will be overridden by SheetTitle if present */}
